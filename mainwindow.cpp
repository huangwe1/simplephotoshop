...

{
    ...
    graAct = new QAction(QIcon("://新建文件夹/1713183507779.jpg"),"灰度图");
    connect(graAct, SIGNAL(triggered()), this, SLOT(gra()));

    stateAct = new QAction(QIcon("://新建文件夹/1713183507779.jpg"),"拖动");
    connect(stateAct, SIGNAL(triggered()), this, SLOT(pressed()));

    masaicAct=new QAction(QIcon("://新建文件夹/1713183507779.jpg"),"马赛克");
